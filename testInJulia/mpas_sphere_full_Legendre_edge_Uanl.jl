...
for iEdge in 1:nEdges
   ...
   #uDiff = (divergence[cell2] - divergence[cell1])*dcEdgeInv - (relativeVorticityCell[cell2] - relativeVorticityCell[cell1])*dcEdgeInv
   #uDiff = (divergence[cell2] - divergence[cell1])*dcEdgeInv - (relativeVorticityCell[cell2] - relativeVorticityCell[cell1])*dcEdgeInv

   #uDiff = (divergenceVert[vertex2] - divergenceVert[vertex1])*dvEdgeInv - (relativeVorticity[vertex2] - relativeVorticity[vertex1])*dvEdgeInv
...
for iEdge in 1:nEdges
    ...
    #tangentialVelocity[iEdge] = tangentialVelocity[iEdge] + (divergence[cell2] - divergence[cell1])*dcEdgeInv
end
...
#println("Usph   "," ",sqrt(Usum0/nEdges))
